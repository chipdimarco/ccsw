# Mozilla Django Tutorial - Part 2
# 10/8/2018
...
# 11-13-2018 Section 9 Challenge
urlpatterns += [  
...
# 11-23-2018 Section 9/10
urlpatterns += [
    path('book/<uuid:pk>/borrow/book_borrowed/', views.bookinstance_detail, name='book_borrowed'),
]